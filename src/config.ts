...
export const siteConfig: SiteConfig = {
	title: "Nagisa",
	subtitle: "Static website deployed on Server",
	siteURL: "https://love.nagisadaisuki.icu/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2025-11-21", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	bangumi: {
		userId: "nagisadaisuki", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	},
	...
	banner: {
      ...
      title: "涼やかなる夢想の可能性",
        ...
        "あら、お疲れ様です先生。お待ちしておりました。 では、本日の仕事を始めましょうか？ふふっ。",
			  "いつもお忙しい先生のお手伝いに、ミレニアムの超天才病弱美少女ハッカーが馳せ参じました。 歓迎の拍手は無いのですか？こう、パチパチパチ…というような。",
        "ミレニアムの清楚な高嶺の花であり、みなさんの憧れである 「全知」の学位を持つ眉目秀麗な乙女から仕事を手伝ってもらえるなんて… 先生はとびっきりの幸運の持ち主ですね。",
        "「特別」を感じられるのは、「普通」があるから。ですので、「普通」を大切にしてくださいね。先生。…ついでに、苦労してる超天才清楚系病弱美少女のことも。",
      ],
			typewriter: {
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				...
				{
					name: "Gitee",
					url: "https://gitee.com/nagisadaisuki",
					external: true,
					icon: "mdi:git",
				},
        {
...
export const profileConfig: ProfileConfig = {
	...
	bio: "Where there's tea party there's hope.",
	typewriter: {
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "Welcome to Nagisa Website!", // 欢迎词
		touch: [
			"What are you doing?",
			"Stop touching me!",
			"HENTAI!",
		...
		link: "hhttps://github.com/NagisaDaisuki", // 关于链接
	},
};
